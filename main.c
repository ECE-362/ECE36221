    ...
    */
    ...
    void wait_countdown(void) {
        LCD_DrawString(160-14*4, 120-8, P2COLOR, BLACK, "5", 16, 0);
        nano_wait(1000000000);
        LCD_Clear(BLACK)
        LCD_DrawString(160-14*4, 120-8, P2COLOR, BLACK, "4", 16, 0);
        nano_wait(1000000000);
        LCD_Clear(BLACK)
        LCD_DrawString(160-14*4, 120-8, P2COLOR, BLACK, "3", 16, 0);
        nano_wait(1000000000);
        LCD_Clear(BLACK)
        LCD_DrawString(160-14*4, 120-8, P2COLOR, BLACK, "2", 16, 0);
        nano_wait(1000000000);
        LCD_Clear(BLACK)
        LCD_DrawString(160-14*4, 120-8, P2COLOR, BLACK, "1", 16, 0);
        nano_wait(1000000000);
    }
